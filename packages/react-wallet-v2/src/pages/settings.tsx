    ...
    return (
        <Fragment>
                                ...
                                <>
                                    ...
                                    <Row justify="space-between" align="center">
                                        <Switch
                                            ...
                                            onChange={
                                                SettingsStore.toggleKernelSmartAccountsEnabled
                                            }
                                            data-testid="settings-toggle-smart-account-sponsorship"
                                        />
                                        <Text>
                                            {kernelSmartAccountEnabled ? 'Enabled' : 'Disabled'}
                                        </Text>
                                    </Row>
                                    ...
                                    <Row justify="space-between" align="center">
                                        ...
                                        />
                                        <Text>
                                            {safeSmartAccountEnabled ? 'Enabled' : 'Disabled'}
                                        </Text>
                                    </Row>
                                    ...
                                    <Row justify="space-between" align="center">
                                        <Switch
                                            ...
                                            onChange={
                                                SettingsStore.toggleBiconomySmartAccountsEnabled
                                            }
                                            data-testid="settings-toggle-smart-account-sponsorship"
                                        />
                                        <Text>
                                            {biconomySmartAccountEnabled ? 'Enabled' : 'Disabled'}
                                        </Text>
                                    </Row>
                                    ...
                                    <Row justify="space-between" align="center">
                                        ...
                                        />
                                        <Text>
                                            {moduleManagementEnabled ? 'Enabled' : 'Disabled'}
                                        </Text>
                                    </Row>
                                </>
                            ) : null}
            ...
            <Text css={{ color: '$yellow500', marginBottom: '$5', textAlign: 'left', padding: 0 }}>
                Warning: mnemonics and secret keys are provided for development purposes only and
